        ...
        child: Padding(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                          data['imageUrl'] == ''&& profileController.profileImagePath.isEmpty ?  Container(
                  ...
                  backgroundImage: NetworkImage(
                    "https://as2.ftcdn.net/v2/jpg/03/60/56/45/1000_F_360564599_mWtUO5Sm6VHSSl0dD6I99P2b11RIOrn0.jpg",
                          ...
                          :Container(
                  child: CircleAvatar(
                    backgroundImage: FileImage(File(profileController.profileImagePath),
                      ),
                  )
                ),
                const SizedBox(
                ...
                const SizedBox(
                  height: 10.0,
                   ...
                   profileController.isLoading ? const CircularProgressIndicator(valueColor: AlwaysStoppedAnimation(Colors.teal)): Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: SizedBox(
